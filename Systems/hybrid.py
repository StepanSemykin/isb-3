...
class HybridSystem:
    def __init__(self, path_json: str) -> None:
        """Initialization of a hybrid encryption system.
        Args:
            path_json (str): path to the settings file.
        """
        try:
    ...
    def generation_keys(self) -> None:
        """Generates symmetric key, asymmetric keys and serializes them.
        """
